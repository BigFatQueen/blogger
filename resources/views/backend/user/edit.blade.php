...
<div class="container ">
    <div class="row">
        ...
        @php @endphp    
            <form method="post" action="{{ route('admin.user.update', \App\Helper\Crypt::crypt()->encrypt( $user->id ))}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="profile_url" class="form-control @error('profile_url') is-invalid @enderror" value="{{$user->userInfo->profile_url}}" autofocus id="profile_url">
                            @error('profile_url')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
